ALTER TABLE product_.product_collection ADD COLUMN owner_name VARCHAR NOT NULL;
ALTER TABLE product_.product_collection ADD COLUMN version VARCHAR NOT NULL,
